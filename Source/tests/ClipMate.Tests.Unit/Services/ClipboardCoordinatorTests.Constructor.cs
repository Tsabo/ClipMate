...
public partial class ClipboardCoordinatorTests
{
    ...
    public async Task Constructor_WithNullClipboardService_ShouldThrowArgumentNullException()
    {
        ...
        // Act & Assert
        await Assert.That(() => new ClipboardCoordinator(null!, serviceProvider, messenger, logger))
    ...
    public async Task Constructor_WithNullServiceProvider_ShouldThrowArgumentNullException()
    {
        ...
        // Act & Assert
        await Assert.That(() => new ClipboardCoordinator(clipboardService.Object, null!, messenger, logger))
            .Throws<ArgumentNullException>();
    }
    ...
    public async Task Constructor_WithNullMessenger_ShouldThrowArgumentNullException()
    {
        ...
        // Act & Assert
        await Assert.That(() => new ClipboardCoordinator(clipboardService.Object, serviceProvider, null!, logger))
            .Throws<ArgumentNullException>();
    }
    ...
    public async Task Constructor_WithNullLogger_ShouldThrowArgumentNullException()
    {
        ...
        // Act & Assert
        await Assert.That(() => new ClipboardCoordinator(clipboardService.Object, serviceProvider, messenger, null!))
            .Throws<ArgumentNullException>();
    }
