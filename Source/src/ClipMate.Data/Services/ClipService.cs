...
public class ClipService : IClipService
{
    ...
    /// <inheritdoc />
    public async Task<Clip?> GetByIdAsync(Guid id, CancellationToken cancellationToken = default) => await _repository.GetByIdAsync(id, cancellationToken);

    /// <inheritdoc />
    public async Task<IReadOnlyList<Clip>> GetRecentAsync(int count, CancellationToken cancellationToken = default) => await _repository.GetRecentAsync(count, cancellationToken);

    /// <inheritdoc />
    public async Task<IReadOnlyList<Clip>> GetByCollectionAsync(Guid collectionId, CancellationToken cancellationToken = default) => await _repository.GetByCollectionAsync(collectionId, cancellationToken);

    /// <inheritdoc />
    public async Task<IReadOnlyList<Clip>> GetByFolderAsync(Guid folderId, CancellationToken cancellationToken = default) => await _repository.GetByFolderAsync(folderId, cancellationToken);

    /// <inheritdoc />
    public async Task<IReadOnlyList<Clip>> GetFavoritesAsync(CancellationToken cancellationToken = default) => await _repository.GetFavoritesAsync(cancellationToken);
    ...
    /// <inheritdoc />
    public async Task<IReadOnlyList<ClipData>> GetClipFormatsAsync(Guid clipId, CancellationToken cancellationToken = default) => await _repository.GetClipFormatsAsync(clipId, cancellationToken);
}
