...
namespace WpfHexaEditor.Core.Bytes
{
    ...
    {
        public Byte_8bit(byte value) => OriginByte = [value];

        private List<byte> _originByte = null!;

        public List<byte> Byte { get; set; } = null!;
        ...
        public D_ByteListProp del_ByteOnChange { get; set; } = null!;
        ...
        public bool IsEqual(byte[] bytes)
        {
            ...
            if (Byte is not { Count: 1 }) return false;
                ...
                case DataVisualType.Decimal:
                    ...
                    switch (_keyDownLabel)
                    {
                        case KeyDownLabel.FirstChar:
                            ...
                            _keyDownLabel = KeyDownLabel.SecondChar;
                            Action = ByteAction.Modified;
                            Byte = [BitConverter.GetBytes(int.Parse(new string(byteValueCharArray_dec)))[0]]; //[change]
                            break;
                ...
                case DataVisualType.Binary:
                    ...
                    switch (_keyDownLabel)
                    {
                        case KeyDownLabel.FirstChar:
                            ...
                            _keyDownLabel = KeyDownLabel.SecondChar;
                            Action = ByteAction.Modified;
                            Byte = [Convert.ToByte(new string(byteValueCharArray_bin), 2)]; //[change]
                            break;
