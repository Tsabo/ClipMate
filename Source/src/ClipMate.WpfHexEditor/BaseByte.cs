...
namespace WpfHexaEditor
{
    ...
    abstract class BaseByte : FrameworkElement, IByteControl
    {
        ...
        public event EventHandler<ByteEventArgs> ByteModified = null!;
        public event EventHandler MouseSelection = null!;
        public event EventHandler Click = null!;
        public event EventHandler RightClick = null!;
        public event EventHandler DoubleClick = null!;
        public event EventHandler<ByteEventArgs> MoveNext = null!;
        public event EventHandler<ByteEventArgs> MovePrevious = null!;
        public event EventHandler<ByteEventArgs> MoveRight = null!;
        public event EventHandler<ByteEventArgs> MoveLeft = null!;
        public event EventHandler<ByteEventArgs> MoveUp = null!;
        public event EventHandler<ByteEventArgs> MoveDown = null!;
        public event EventHandler<ByteEventArgs> MovePageDown = null!;
        public event EventHandler<ByteEventArgs> MovePageUp = null!;
        public event EventHandler ByteDeleted = null!;
        public event EventHandler EscapeKey = null!;
        public event EventHandler CtrlzKey = null!;
        public event EventHandler CtrlvKey = null!;
        public event EventHandler CtrlcKey = null!;
        public event EventHandler CtrlaKey = null!;
        public event EventHandler CtrlyKey = null!;
        ...
        protected FormattedText TextFormatted { get; private set; } = null!;
        ...
        protected void UpdateAutoHighLiteSelectionByteVisual()
        {
            if (_parent.AllowAutoHighLightSelectionByte && _parent.SelectionByte is not null &&
                Byte is not null && Byte.IsEqual([_parent.SelectionByte.Value]) && !IsSelected)
