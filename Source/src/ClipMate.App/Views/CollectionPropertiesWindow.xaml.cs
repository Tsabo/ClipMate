...
{
    public CollectionPropertiesWindow(CollectionPropertiesViewModel viewModel)
    {
        InitializeComponent();
        DataContext = viewModel;

        SqlEditor.Text = viewModel.SqlQuery;
        SqlEditor.Font = new Font("Consolas", 10);

        // KEYWORD, fontStyle = 1 
        SqlEditor.Styles[ScintillaNET.Style.Sql.Word].Bold = true;
        SqlEditor.Styles[ScintillaNET.Style.Sql.Word].ForeColor = Color.FromArgb(0, 0, 255);
        SqlEditor.Styles[ScintillaNET.Style.Sql.Word].BackColor = Color.FromArgb(255, 255, 255);

        // NUMBER, fontStyle = 0 
        SqlEditor.Styles[ScintillaNET.Style.Sql.Number].ForeColor = Color.FromArgb(255, 128, 0);
        SqlEditor.Styles[ScintillaNET.Style.Sql.Number].BackColor = Color.FromArgb(255, 255, 255);

        // STRING, fontStyle = 0 
        SqlEditor.Styles[ScintillaNET.Style.Sql.String].ForeColor = Color.FromArgb(128, 128, 128);
        SqlEditor.Styles[ScintillaNET.Style.Sql.String].BackColor = Color.FromArgb(255, 255, 255);

        // STRING2, fontStyle = 0 
        SqlEditor.Styles[ScintillaNET.Style.Sql.Character].ForeColor = Color.FromArgb(128, 128, 128);
        SqlEditor.Styles[ScintillaNET.Style.Sql.Character].BackColor = Color.FromArgb(255, 255, 255);

        // OPERATOR, fontStyle = 1 
        SqlEditor.Styles[ScintillaNET.Style.Sql.Operator].Bold = true;
        SqlEditor.Styles[ScintillaNET.Style.Sql.Operator].ForeColor = Color.FromArgb(0, 0, 128);
        SqlEditor.Styles[ScintillaNET.Style.Sql.Operator].BackColor = Color.FromArgb(255, 255, 255);

        // COMMENT, fontStyle = 0 
        SqlEditor.Styles[ScintillaNET.Style.Sql.Comment].ForeColor = Color.FromArgb(0, 128, 0);
        SqlEditor.Styles[ScintillaNET.Style.Sql.Comment].BackColor = Color.FromArgb(255, 255, 255);

        // COMMENT LINE, fontStyle = 0 
        SqlEditor.Styles[ScintillaNET.Style.Sql.CommentLine].ForeColor = Color.FromArgb(0, 128, 0);
        SqlEditor.Styles[ScintillaNET.Style.Sql.CommentLine].BackColor = Color.FromArgb(255, 255, 255);
        ...
        SqlEditor.SetKeywords(0, keywords);

        SqlEditor.TextChanged += (s, e) => viewModel.SqlQuery = SqlEditor.Text;
    }
    ...
    {
        if (DataContext is CollectionPropertiesViewModel viewModel)
        {
            viewModel.SqlQuery = SqlEditor.Text;
        }
    }
}
